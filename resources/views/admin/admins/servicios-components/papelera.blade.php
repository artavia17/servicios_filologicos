                    ...
                    @if(count($data))
                        @foreach($data as $value)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin_servicios_publicar_update', $value->id)}}" class="mdc-button mdc-button--unelevated mdc-ripple-upgraded p-3" >
                                        Publicar
                                    </a>
                                </td>
                                <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin_servicios_eliminar', $value->id)}}" class="mdc-button mdc-button--unelevated filled-button--secondary mdc-ripple-upgraded p-3">
                                                Aceptar y Eliminar
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <td>
                                    <a href="{{route('admin_servicios_individual', $value->slug)}}" class="mdc-button mdc-button--unelevated filled-button--success mdc-ripple-upgraded p-3">
                                        Ver
                                    </a>
                                </td>
                            </tr>
