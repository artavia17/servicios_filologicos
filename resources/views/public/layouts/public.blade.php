...
<head>
    ...
    <meta property="og:image" content="@yield('og_image', asset('img/logo-og.png'))">
    <meta property="og:image:secure_url" content="@yield('og_image', asset('img/logo-og.png'))">
    ...
    <meta name="twitter:image" content="@yield('twitter_image', asset('img/logo-og.png'))">
    ...
    <!-- Favicon and Icons -->
    <link rel="icon" type="image/png" href="{{asset('img/logo-google.png')}}">
    <link rel="shortcut icon" href="{{asset('img/logo-google.png')}}">
    <link rel="apple-touch-icon" href="{{asset('img/logo-google.png')}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('img/logo-google.png')}}">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "{{ asset('img/logo-google.png') }}",
      "logo": "{{ asset('img/logo-google.png') }}",
...
<body>
    <div id="app">
                ...
                <div class="navbar-brand d-flex" href="#">
                    <div class="d-flex">
                        <a href="/" class="icon_site" aria-label="Inicio - Servicios Filológicos">
                            <img src="{{asset('img/SVG/logo_escritorio.svg')}}" alt="Logo Servicios Filológicos - Corrección de tesis y clases de español" class="icons me-3 movile_desaparecer" width="150" height="50" loading="eager">
                            <img src="{{asset('img/SVG/logo.svg')}}" alt="Logo Servicios Filológicos" class="icons me-3 movil_view" width="40" height="40" loading="eager">
                        </a>
                        <a href="https://www.linkedin.com/in/fiorella-%C3%A1lvarez-ram%C3%ADrez-b1099878" target="_blank" rel="noopener noreferrer" class="movil_view" aria-label="Visitar perfil de LinkedIn">
                            <img src="{{asset('img/SVG/linke.svg')}}" class="icons" alt="LinkedIn Servicios Filológicos" width="30" height="30" loading="lazy">
                        </a>
                    </div>
                    <a class="movile_desaparecer" href="https://api.whatsapp.com/send?phone=50687295068" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp" style="display: flex; align-items: center;">
                        <img src="{{asset('img/SVG/whatsapp.svg')}}" class="icons me-3" alt="Contacto WhatsApp +506 8729 5068" width="30" height="30" loading="lazy">
                    </a>
        ...
        <a href="https://api.whatsapp.com/send?phone=50687295068" target="_blank" rel="noopener noreferrer" class="movil_view fixed_icon-whatsapp" aria-label="Contactar por WhatsApp">
            <img src="{{asset('img/SVG/whatsapp.svg')}}" class="icons" alt="Contacto WhatsApp Servicios Filológicos" width="50" height="50" loading="lazy">
        </a>
    ...
    <script src="{{asset('js/aos_entry_animation.js')}}"></script>
